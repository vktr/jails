...
namespace Jails.Environments.Nancy.Tests
{
    public class NancyTests
    {
        ...
        public void Should_Compile_And_Run_Source_In_Sandbox()
        {
            ...
            isolator.Options.Permissions.AddPermission(new FileIOPermission(FileIOPermissionAccess.PathDiscovery, @"C:\Code\jailsfx\jails\src\Jails.Environments.Nancy.Tests\bin\Debug\"));
